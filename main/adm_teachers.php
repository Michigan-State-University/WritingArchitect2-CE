	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				<br>
				<?php if ($GLOBALS['USER_LEVEL'] == 'ADMIN' || $GLOBALS['USER_LEVEL'] == 'SCORER') { ?>
					<a href="edit_user.php?USER_LEVEL=TEACHER&uid=0&id=<?php echo $GLOBALS["SESSION_ID"] ?>" class="waButtonSmall">Create New Teacher</a>
				<?php } ?>
				<?php echo list_teachers($db); ?>
			</div>
		</div>
	</div>
	<!-- Bootstrap core JS-->
