	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				<br>
				<a href="edit_user.php?USER_LEVEL=STUDENT&uid=0&id=<?php echo $GLOBALS["SESSION_ID"] ?>" class="waButtonSmall">Create New Student</a>
				<?php echo list_students($db, $GLOBALS['USER_ORGANIZATION']); ?>
			</div>
		</div>
	</div>
	<br><br>
