...
<head>
	...
	<script language="javascript">
		function delete_record(schoolname) {
			var msg_str = "Delete " + schoolname + "?";
			if (confirm(msg_str)) {
	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				<br>
				<a href="edit_school.php?sid=0&id=<?php echo $GLOBALS["SESSION_ID"] ?>" class="waButtonSmall">Create New School</a>
				<?php echo list_schools($db); ?>
			</div>
		</div>
	</div>
	<!-- Bootstrap core JS-->
