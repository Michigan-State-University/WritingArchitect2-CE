	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				<br>
				<?php if ($GLOBALS['USER_LEVEL'] == 'ADMIN' || $GLOBALS['USER_LEVEL'] == 'TEACHER') { ?>
					<a href="edit_user.php?USER_LEVEL=SCORER&uid=0&id=<?php echo $GLOBALS["SESSION_ID"] ?>" class="waButtonSmall">Create New Scorer</a>
				<?php }
				echo list_scorers($db); ?>
			</div>
		</div>
	</div>
	<!-- Bootstrap core JS-->
