...
let sampleWords = [
  "Many", "schools", "should", "adopt", "longer", "lunch", "breaks", "to", "improve", "student", "well-being.",
  "Studies", "show", "that", "when", "students", "have", "more", "time", "to", "eat", "and", "relax,", 
  "their", "focus", "in", "class", "improves", "dramatically.",
  "At", "Lincoln", "High,", "for", "example,", "grades", "and", "attendance", "rose", "after", "the", 
  "school", "extended", "lunch", "by", "just", "15", "minutes.",
  "In", "addition", "to", "academic", "benefits,", "longer", "breaks", "give", "students", "time", "to", 
  "socialize,", "reducing", "stress", "and", "building", "stronger", "peer", "relationships.",
  "If", "schools", "truly", "care", "about", "student", "success,", 
  "they", "must", "start", "by", "rethinking", "the", "time", "given", "to", "recharge", "during", "the", "day."
];
